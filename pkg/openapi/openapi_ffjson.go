...
// source: internal/gen/openapi/openapi.go
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				tok = fs.Scan()
				/* handler: tmpJPaths type=openapi.Path kind=struct quoted=false*/
...
handle_Get:
	...
	/* handler: j.GetSlice type=openapi.Operation kind=struct quoted=false*/
