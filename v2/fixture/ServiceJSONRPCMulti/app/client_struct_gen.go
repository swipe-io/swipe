...
func NewClientJSONRPC(tgt string, opts ...ClientOption) (*AppClient, error) {
	interfaceAClient, err := NewClientJSONRPCInterfaceA(tgt, opts...)
	if err != nil {
		return nil, err
	}
	interfaceBClient, err := NewClientJSONRPCInterfaceB(tgt, opts...)
	if err != nil {
		return nil, err
	}
	return &AppClient{
...
type clientOpts struct {
	interfaceATestMethodClientOption        []jsonrpc.ClientOption
