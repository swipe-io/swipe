...
class JSONRPCClientService {
  ...
  create(newData, name, data) {
    return this.scheduler.__scheduleRequest("service.create", {
      newData: newData,
      name: name,
      data: data
    });
   ...
   **/
  delete(id) {
    return this.scheduler.__scheduleRequest("service.delete", { id: id });
  }
  /**
   *  Get item.
   *
  ...
  get(id, name, fname, price, n, b, cc) {
    return this.scheduler.__scheduleRequest("service.get", {
      id: id,
      name: name,
      fname: fname,
      price: price,
   ...
   **/
  getAll(members) {
    return this.scheduler.__scheduleRequest("service.getAll", {
      members: members
    });
  }
  /**
   ...
   **/
  testMethod(data, ss) {
    return this.scheduler.__scheduleRequest("service.testMethod", {
      data: data,
      ss: ss
    });
  }
  ...
  testMethod2(ns, utype, user, restype, resource, permission) {
    return this.scheduler.__scheduleRequest("service.testMethod2", {
      ns: ns,
      utype: utype,
      user: user,
      restype: restype,
