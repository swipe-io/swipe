...
// Code generated by Swipe v1.13.2. DO NOT EDIT.
...
func (s *loggingMiddlewareServiceInterface) TestMethod(data map[string]interface{}, ss interface{}) (result map[string]map[int][]string, err error) {
	defer func(now time.Time) {
...
func (s *instrumentingMiddlewareServiceInterface) TestMethod(data map[string]interface{}, ss interface{}) (_ map[string]map[int][]string, _ error) {
	defer func(begin time.Time) {
